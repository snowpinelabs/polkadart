...
//
// Paste PUBLIC into lib/src/prebuilt.dart (kPrebuiltPublicKeyHex) and store PRIVATE as the
// `SMOLDOT_SIGNING_KEY` repository secret consumed by .github/workflows/release_smoldot.yml.
